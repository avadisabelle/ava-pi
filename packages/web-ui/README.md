# @avadisabelle/ava-pi-web-ui

Reusable web UI components for building AI chat interfaces powered by [@avadisabelle/ava-pi-ai](../ai) and [@avadisabelle/ava-pi-agent-core](../agent).
...
```bash
npm install @avadisabelle/ava-pi-web-ui @avadisabelle/ava-pi-agent-core @avadisabelle/ava-pi-ai
```
...
import {
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@avadisabelle/ava-pi-web-ui';
import '@avadisabelle/ava-pi-web-ui/app.css';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@avadisabelle/ava-pi-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@avadisabelle/ava-pi-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@avadisabelle/ava-pi-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@avadisabelle/ava-pi-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@avadisabelle/ava-pi-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@avadisabelle/ava-pi-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@avadisabelle/ava-pi-web-ui';
...
```typescript
import { SessionListDialog } from '@avadisabelle/ava-pi-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@avadisabelle/ava-pi-web-ui';
...
```typescript
import { ModelSelector } from '@avadisabelle/ava-pi-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@avadisabelle/ava-pi-web-ui';
