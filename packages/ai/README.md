...
```bash
npm install @avadisabelle/ava-pi-ai
```

TypeBox exports are re-exported from `@avadisabelle/ava-pi-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@avadisabelle/ava-pi-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@avadisabelle/ava-pi-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@avadisabelle/ava-pi-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@avadisabelle/ava-pi-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@avadisabelle/ava-pi-ai';
...
```typescript
import { getModel, stream } from '@avadisabelle/ava-pi-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@avadisabelle/ava-pi-ai';
...
```typescript
import { Model, stream } from '@avadisabelle/ava-pi-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@avadisabelle/ava-pi-ai';
...
```typescript
import { getModel, complete, Context } from '@avadisabelle/ava-pi-ai';
...
```typescript
import { Context, getModel, complete } from '@avadisabelle/ava-pi-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@avadisabelle/ava-pi-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@avadisabelle/ava-pi-ai';
...
npx @avadisabelle/ava-pi-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@avadisabelle/ava-pi-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
```typescript
import { loginGitHubCopilot } from '@avadisabelle/ava-pi-ai/oauth';
...
```typescript
import { getModel, complete } from '@avadisabelle/ava-pi-ai';
import { getOAuthApiKey } from '@avadisabelle/ava-pi-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@avadisabelle/ava-pi-ai`
