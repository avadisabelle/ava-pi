...
Pi runs in four modes: interactive, print or JSON, RPC for process integration, and an SDK for embedding in your own apps. See [avaclaw/avaclaw](https://github.com/avaclaw/avaclaw) for a real-world SDK integration.
