...
import { type ImageContent, modelsAreEqual, supportsXhigh } from "@avadisabelle/ava-pi-ai";
import { ProcessTerminal, setKeybindings, TUI } from "@avadisabelle/ava-pi-tui";
...
export async function main(args: string[], options?: MainOptions) {
	...
	const resolvedExtensionPaths = [...discoverBundledExtensions(), ...(resolveCliPaths(cwd, parsed.extensions) ?? [])];
