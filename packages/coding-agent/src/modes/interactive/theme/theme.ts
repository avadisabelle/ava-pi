...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@avadisabelle/ava-pi-tui";
...
const THEME_KEY = Symbol.for("@avadisabelle/ava-pi-coding-agent:theme");
...
export function getSettingsListTheme(): import("@avadisabelle/ava-pi-tui").SettingsListTheme {
	return {
