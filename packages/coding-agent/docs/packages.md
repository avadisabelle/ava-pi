...
Pi bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@avadisabelle/ava-pi-ai`, `@avadisabelle/ava-pi-agent-core`, `@avadisabelle/ava-pi-coding-agent`, `@avadisabelle/ava-pi-tui`, `@sinclair/typebox`.
