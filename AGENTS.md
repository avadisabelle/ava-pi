...
tmux send-keys -t pi-test "cd /Users/badlogic/workspaces/ava-pi && ./pi-test.sh" Enter
...
- **Internal changes (from issues)**: `Fixed foo bar ([#123](https://github.com/avadisabelle/ava-pi/issues/123))`
- **External contributions**: `Added feature X ([#456](https://github.com/avadisabelle/ava-pi/pull/456) by [@username](https://github.com/username))`
